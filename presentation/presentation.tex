...
\begin{frame}{Pulse Width Modulation Example}
  \begin{center}
    \includegraphics[width=0.8\textwidth]{/home/schirner/work/ai-prog-workshop/1-script/period_timer.png}
  \end{center}
  \begin{itemize}
...
\begin{frame}{Sample Output: CDF Visualization}
  \begin{center}
    \includegraphics[width=0.9\textwidth]{/home/schirner/work/ai-prog-workshop/1-script/pwm_sleep_edges_loaded_latency_cdf.png}
  \end{center}
  \begin{itemize}
