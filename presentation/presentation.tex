\documentclass[xcolor={dvipsnames,table}, aspectratio=169,handout]{beamer}
...
\institute{Part of the AI Summer Series \\
  IMPACT and AI Council \\ 
  College of Engineering\\
  \href{https://coeai.sites.northeastern.edu/}{https://coeai.sites.northeastern.edu/}\\
  Northeastern University, Boston MA, USA}
\newcommand{\footername}{AI in Programming Education}
\newcommand{\setfooter}[2]{\renewcommand{\footername}{\href{#2}{#1}}}

\begin{document}
\setfooter{AI in Programming Education}{https://github.com/neu-ece-esl/ai-prog-workshop}

\begin{frame}[plain]
  \titlepage
\end{frame}

% disabled not usefule, main info is agenda that  has it already
% \begin{frame}{Outline}
...
\begin{frame}{Workshop Information}
  \begin{columns}
    \begin{column}{0.58\textwidth}
      ...
      \textbf{Resources}
      \begin{itemize}\small
        \item GitHub repo: \href{https://github.com/neu-ece-esl/ai-prog-workshop}{neu-ece-esl/ai-prog-workshop}
      \end{itemize}
      \textbf{Agenda}
      \begin{itemize}\small
...
\begin{frame}{Evolution of Programming Abstractions}
  \begin{columns}
    \begin{column}{0.6\textwidth}
      \begin{itemize}
        \item Abstraction: Increase managable system complex with less code
        \item Less implementation detail, more system design
        \item Concerns: (1) performance, (2) loss of control
    ...
    \begin{column}{0.4\textwidth}
      ...
      \begin{tikzpicture}[scale=0.9]
        ...
        \node[anchor=west, align=left, font=\tiny] at (4.6,3.2) {Less code};
        \node[anchor=west, align=left, font=\tiny] at (4.6,2.8) {More design focus};
        
        \node[anchor=west, align=left, font=\tiny] at (4.6,0.8) {More control}; 
        \node[anchor=west, align=left, font=\tiny] at (4.6,0.4) {More implementation detail};
      \end{tikzpicture}
    \end{column}
  \end{columns}
  ...
  \begin{columns}
    \begin{column}{0.6\textwidth}
      ...
      \begin{alertbox}
        ...
        \begin{itemize}
          \item Pilot is in charge, Autopilot assists 
    ...
    \begin{column}{0.4\textwidth}
      \only<4->{
      \centering\includegraphics[width=0.8\textwidth]{images/AutoPilot.png}
      \tiny\centerline{"AI Autopilot" by ChatGPT from this slide}
      }
    \end{column}
...
\begin{frame}{1 Script: Auxiliary Code Generation Overview}
  \begin{columns}[T]
  ...
  \only<3->{\begin{infobox}
    \textbf{Benefits to Students}
    \begin{itemize}\small
...
\begin{frame}{2 Review: Code Review and Improvement}
    \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \only<1->{\textbf{Pedagogical Need}
...
\begin{frame}{2 Review Code Review: Instructor Activity}
...
\section{3 Assist: Copilot Integration}
\setfooter{3 Assist}{https://github.com/neu-ece-esl/ai-prog-workshop/tree/main/3-assist}

\begin{frame}{3 Assist: Copilot in VS Code}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \only<1->{\textbf{Pedagogical Need}
      \begin{itemize}\small
...
\begin{frame}{4 Vibe: Agent Mode for Complex Projects}
  \begin{columns}[T]
    \begin{column}{0.5\textwidth}
      \only<1->{\textbf{Pedagogical Need}
      \begin{itemize}\small
...
\begin{frame}{Assistance Levels Summary}
  \colorlet{lightred}{red!60!black}
...
\begin{frame}{Thank You!}
  \begin{center}
    ...
    GitHub Repository:\\
    \href{https://github.com/neu-ece-esl/ai-prog-workshop}{https://github.com/neu-ece-esl/ai-prog-workshop}
    \vspace{2em} \\
    Web Page:\\
     \href{https://coeai.sites.northeastern.edu/}{https://coeai.sites.northeastern.edu/}
  \end{center}
