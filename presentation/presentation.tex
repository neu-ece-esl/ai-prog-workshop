...
\begin{frame}{Paradigm Shift in Programming}
  \begin{columns}
    ...
    \begin{column}{0.4\textwidth}
      % Add the image manually:
      % 1. Download the image from: https://www.vecteezy.com/vector-art/3216651-ai-artificial-intelligence-robot-team-developer-programmer
      % 2. Save it as "ai_robot_team_developer.jpg" in the images directory
